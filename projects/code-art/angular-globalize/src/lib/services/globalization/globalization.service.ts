...
import { Dictionary, FormatterFactory, FormatterFunction,
     ParserFactory, ParserFunction, DurationFormatOptions, MonthNameFormat, DayNameFormat } from '../../models';
...
export class GlobalizationService {
    ...
    public formatDate(
        val: Date, options?: Globalize.DateFormatterOptions): string;
    public formatDate(
        val: Date, locale?: string|null, options?: Globalize.DateFormatterOptions): string;
    public formatDate(
        val: Date,
    ...
    public parseNumber(
        val: string, options?: Globalize.NumberParserOptions): number|null;
    public parseNumber(
        val: string, locale?: string, options?: Globalize.NumberParserOptions): number|null;
    public parseNumber(
            val: string,
            localeOrOptions?: string | Globalize.NumberParserOptions | undefined,
            options?: Globalize.NumberParserOptions): number|null {
    ...
    public formatNumber(
        val: number, options?: Globalize.NumberFormatterOptions): string;
    public formatNumber(
        val: number, locale?: string, options?: Globalize.NumberFormatterOptions): string;
    public formatNumber(
        val: number,
    ...
    public formatCurrency(
        val: number, currency: string, options?: Globalize.CurrencyFormatterOptions): string;
    public formatCurrency<T extends number|null|undefined>(
        val: number, currency: string, locale?: string, options?: Globalize.CurrencyFormatterOptions): string;
    public formatCurrency(
            val: number,
            currency: string,
            localeOrOptions: string | Globalize.CurrencyFormatterOptions | undefined,
    ...
    public getMonthName<T extends number|null|undefined>(
        month: number, type?: MonthNameFormat): string;
    public getMonthName(
            month: number,
            locale?: string,
    ...
    public getDayName<T extends number|null|undefined>(
        day: number, type?: DayNameFormat): string;
    public getDayName(
        day: number,
        locale?: string,
